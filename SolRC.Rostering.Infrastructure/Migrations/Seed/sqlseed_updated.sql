...
(NEWID(), 'ORD5513', 'ORD55134', (SELECT Id FROM [Lookups] WHERE Code = 'GAME' AND Name = 'RL'), 50, NULL, (SELECT p.Id FROM Pits p inner join GamingFloor a on p.GamingFloorId = a.Id where a.Code = 'ETG' and p.Name = '55')),
